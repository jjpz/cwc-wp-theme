...
<body <?php body_class(); ?>>
    ...
    <nav class="nav">
        ...
        <div class="nav-container">
            <div class="col-6 col-lg-2 order-1 nav-col nav-col-left nav-language">
            ...
            wp_nav_menu(
                array(
                    ...
                    'container_class' => 'col-lg-8 order-3 order-lg-2 nav-col nav-col-main nav-menu-container'
                )
            );
            ?>
            <div class="col-6 col-lg-2 order-2 order-lg-3 nav-col nav-col-right nav-portal">
